...
# ==================== NO CLI - Using Hardcoded Configuration ====================
# This version does NOT use command-line arguments
# Edit the configuration variables at the top of the file (lines 175-190)
...
def main():
    ...
    print("\n✅ Script loaded successfully - NO CLI version with hardcoded configuration!")
    print(f"   Input file: {INPUT_FILE}")
    print(f"   Output dir: {OUTPUT_DIR}")
    print(f"   Station ID: {STATION_ID if STATION_ID else 'All stations'}")
    print("\n   To change settings, edit lines 175-190 in this file.")
